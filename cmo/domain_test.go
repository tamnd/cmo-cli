...
// HTTP behaviour is covered in cmo_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "cmo://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("cmo", "about")
	if err != nil || got.String() != "cmo://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want cmo://page/about", got.String(), err)
	}
}
